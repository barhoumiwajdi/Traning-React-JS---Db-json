...
function Register() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(users);
      const trouve = users.data.find((user) => user.email === registerForm.email)   
      if (trouve != null) {
        console.log('email has ulready been used ')
      }
      else {
              ...
              <div className="row">
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                    <input type="text" onChange={handleChange} id='firstname'  className="form-control" />
                    <label className="form-label" for="form3Example1">First name</label>
                  </div>
                </div>
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                    <input type="text" onChange={handleChange} id='lastname' className="form-control"  />
